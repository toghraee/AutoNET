...
echo "<html>";
echo "<head>";
echo "<title>AutoNet\\ DCHP Scope Generator change for A</title>";
echo "</head>";
echo "<body bgcolor=#009999 lang=EN-US style='tab-interval:.5in'>";
echo "<P fontsize=15 align=center>";
echo " AutoNet\\ DCHP Scope change for A </p>";
echo "<br>";
...
$sql=$sql."bld_newname not in ('A11','E2') and bld_newname like 'A%' order by 1";
