...
$sql=$sql."src_switch='EarthNET_Core_01' and src_roomid!=dst_roomid order by 1,2";
...
while ($row=mysql_fetch_assoc($result)) {
		...
		echo "no interface ethernet ".$row['src_slot']."/".$row['src_port'];
		echo "<BR>";
...
//		echo "no interface ethernet ".$row['src_slot']."/".$row['src_port'];
		...
		echo "<BR>";
		echo "port-name [UPLINK TO BLD: $bld ".$row['dst_type']." ".$row['dst_switch']." Eth ".$row['dst_slot']."/".$row['dst_port']." ]";
		echo "<BR>";
...
$sql="select src_slot, src_port, src_ip, dst_type, dst_bld, dst_switch, dst_slot, dst_port, dst_ip ";
$sql=$sql." from portmapping where ";
$sql=$sql."src_switch='EarthNET_Core_02' and src_roomid!=dst_roomid order by 1,2";
...
while ($row=mysql_fetch_assoc($result)) {
		...
		echo "interface ethernet ".$row['src_slot']."/".$row['src_port'];
		echo "<BR>";
		echo "port-name [UPLINK TO BLD: $bld ".$sow['dst_type']." ".$row['dst_switch']." Eth ".$row['dst_slot']."/".$row['dst_port']." ]";
		echo "<BR>";
		echo "ip address  ".$row['src_ip'];
		echo "<BR>";
		echo "ip pim-sparse";
...
$sql="select src_slot, src_port, src_ip, dst_type, dst_bld, dst_switch, dst_slot, dst_port, dst_ip ";
$sql=$sql." from portmapping where ";
$sql=$sql."src_switch='SpaceNET_Core_01' and src_roomid!=dst_roomid order by 1,2";
...
$sql="select src_slot, src_port, src_ip, dst_type, dst_bld, dst_switch, dst_slot, dst_port, dst_ip ";
$sql=$sql." from portmapping where ";
$sql=$sql."src_switch='SpaceNET_Core_02' and src_roomid!=dst_roomid order by 1,2";
